...
<body>
	...
	<div>
		班级:<label id="teacherSatisDetail_className"></label>&nbsp;&nbsp;&nbsp;&nbsp;
		教师：<label id="teacherSatisDetail_teacherName"></label><br> 年份：<label
			id="teacherSatisDetail_year"></label>&nbsp;&nbsp;&nbsp;&nbsp; 月份：<label
			id="teacherSatisDetail_month"></label><br> 样本数：<label
			id="teacherSatisDetail_sampleNumber"></label>&nbsp;&nbsp;&nbsp;&nbsp;
		班级人数：<label id="teacherSatisDetail_classPeopleNumber"></label><br>
	...
	<div>
		...
		<a href="back/satisfaction/showTeacherSatisfaction.jsp" style=" text-decoration:none;font-size:15px;padding-left:360px; ">回    退</a>
	</div>
...
<script type="text/JavaScript">
	...
	//console.info("teacherName："+teacherName);
	...
	$("#teacherSatisDetail_className").text(className);
	$("#teacherSatisDetail_teacherName").text(teacherName);
	$("#teacherSatisDetail_year").text(openYear);
	$("#teacherSatisDetail_month").text(openMonth);
	$("#head").text("   班级：" + className + "     老师：" +teacherName);
	$.post("showTeacherSatisfactionDetailAction.action", {
		id : id,
		className : className,
	}, function(data) {
		if (data.responseCode == 1) {
			...
			for (var i = 0; i < data.obj.length; i++) {
				...
				if(data.obj[i].sampleCount==''){
					data.obj[i].sampleCount=0;
				}
				$("#teacherSatisDetail_sampleNumber").text(
						data.obj[i].sampleCount);
				$("#teacherSatisDetail_classPeopleNumber").text(
			...
			if($("#teacherSatisDetail_sampleNumber").text()==''){
	...
	if($("#teacherSatisDetail_classPeopleNumber").text()==''){
		//$("#teacherSatisDetail_sampleNumber").text('0');
